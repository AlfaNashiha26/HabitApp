...
class RandomHabitActivity : AppCompatActivity() {
    private lateinit var adapter: RandomHabitAdapter
    private lateinit var viewModel: RandomHabitViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = RandomHabitAdapter { habit ->
        ...
        viewModel = ViewModelProvider(this, factory).get(RandomHabitViewModel::class.java)
